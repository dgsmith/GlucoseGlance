...
class ExtensionDelegate: NSObject, WKExtensionDelegate {
    ...
    let logger = Logger(
        subsystem: "me.graysonsmith.GlucoseGlance.watchkitapp.watchkitextension.ExtensionDelegate",
...
let scheduleLogger = Logger(
    subsystem: "me.graysonsmith.GlucoseGlance.watchkitapp.watchkitextension.scheduleLogger",
    category: "Scheduler")
